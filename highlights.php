	...
	<body class="home-two">
        ...
        <div id="rs-blog" class="rs-blog sec-spacer">
            <div class="container">
                <div class="row">  
					 <?php
                                $geteventdata	=	$Q($link,"SELECT * FROM `blogs` WHERE `status` = '1' ORDER BY `order` DESC");
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
						<div class="single-blog-slide">
							<div class="images">
                                ...
                                <img src="news/<?php echo $getdataeve['filefl']?>" alt="Highlights">
                                	<?php } else{?>
                            ...
                            <div class="blog-details">
                                ...
                                <h3><a href="hsingle.php?hid=<?php echo $getdataeve['id'];?>"><?php echo $getdataeve['title'];?> </a></h3>
                                <p><?php custom_echo($getdataeve['content'], 100); ?></p>
                                <div class="read-more">
                                    <a href="hsingle.php?hid=<?php echo $getdataeve['id'];?>">Read More</a>
                                </div>
                            </div>
						</div> 
					</div>
