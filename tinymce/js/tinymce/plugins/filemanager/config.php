...
/*$base_url="http://staarenterprises"; //url base of site if you want only relative url leave empty
$upload_dir = '/tinymce/editor_images/'; // path from base_url to upload base dir
...
$upload_dir = '/se/tinymce/editor_images/'; // path from base_url to upload base dir
$current_path = '../../../../editor_images/'; // relative path from filemanager folder to upload files folder
